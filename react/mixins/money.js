...
export const MoneyMixin = superclass =>
    class extends superclass {
        _formatCurrency(money, currency, useSymbol) {
        ...
        formatMoney(value, currency, places, separator, thousands, useSymbol) {
            ...
            separator =
                separator === null || separator === undefined ? defaultSeparator : separator;
            thousands =
                thousands === null || thousands === undefined ? defaultThousands : thousands;
            ...
            money += places
                ? separator +
                  Math.abs(Math.abs(value) - integer)
                      ...
                      .slice(2)
                : "";
            money = currency ? this._formatCurrency(money, currency, useSymbol) : money;
            return money;
        }
    };
